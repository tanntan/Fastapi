...
[![codecov](https://codecov.io/gh/tanntan/Fastapi/branch/main/graph/badge.svg?token=Fastapi_token_here)](https://codecov.io/gh/tanntan/Fastapi)
[![CI](https://github.com/tanntan/Fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/tanntan/Fastapi/actions/workflows/main.yml)

Awesome fastapi created by tanntan

## Install

from source
```bash
git clone https://github.com/tanntan/Fastapi fastapi
cd fastapi
make install
```
